...
def summit_is_visible_online(location_point, location_summit, plot = False, offset_view = 2, offset_summit = -100, samples=False):
...
def summit_is_visible_fast_online(location_point, location_summit, offset_view = 2, offset_summit = -100, samples=False):
...
def summit_is_visible_fast_offline(location_point, location_summit, offset_view = 2, offset_summit = -100, samples=False):
...
def summit_is_visible_multi_locations_offline(grid_locations, location_summit, offset_view, offset_summit):
...
def summit_is_visible_multi_locations_online(grid_locations, location_summit, offset_view, offset_summit):
    ...
    view_possible_list = np.array(view_possible_list, dtype=object)
