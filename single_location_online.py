...
offset_view = 1000 # Your elevation from the ground of your location_point (can be either positive or 0)
...
view_possible, _ = summit_is_visible_online(location_point, location_summit, plot=True, offset_view=offset_view, offset_summit=offset_summit, samples=3)